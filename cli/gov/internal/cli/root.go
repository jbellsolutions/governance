...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "gov-pp-cli",
		Short: "Manage gov resources via the gov API",
		Long: `Manage gov resources via the gov API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'gov-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("gov-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'gov-pp-cli profile list')")
